...
void list_of_files(){
	...
	std::cout << "ZAWARTOSC FOLDERU: " << std::endl;
	cout << endl;
...
void relation2(){
	...
	graph_making(mapa_deklaracji_funkcji, name, 0);
...
void relation3(){
	...
	for (auto it = pliki.begin(); it != pliki.end(); it++) 
	{
		...
		while (!plik.eof()) 
		{
			...
			if (linijka.find("(") != string::npos && linijka.find(");") != string::npos && linijka.find("for") == string::npos && linijka.find("testing") == string::npos && linijka.find("int") == string::npos && linijka.find("ASSERT_TRUE") == string::npos && linijka.find("std") == string::npos && linijka.find("return") == string::npos && linijka.find("while") == string::npos && linijka.find("if") == string::npos && linijka.find(".") == string::npos && linijka.find("void") == string::npos && linijka.find("system") == string::npos && linijka.find("getline") == string::npos && linijka.find("template") == string::npos)
			{
				gdzie = szukany.size();
	...
	for (auto ii = mapa_pol_funkcji.begin(); ii != mapa_pol_funkcji.end(); ii++)
	{
		RemoveDuplicates(ii->second);
	}
	...
	param_of_graph(mapa_pol_funkcji);
	connections(mapa_pol_funkcji);

	string name = "graf_funkcje.dot";
	graph_making(mapa_pol_funkcji, name, 1);

	string name1 = "graf_pliki_funkcje.dot";
...
void relation5(){
	...
	graph_making(mapa_pol_namespace, name, 0);
